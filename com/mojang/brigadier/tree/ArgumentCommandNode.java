...
public class ArgumentCommandNode extends CommandNode {
    ...
    public boolean isValidInput(String input) {
        try {
            StringReader ignored = new StringReader(input);

            this.type.parse(ignored);
            return !ignored.canRead() || ignored.peek() == 32;
    ...
    public boolean equals(Object o) {
        if (this == o) {
            ...
            return !this.name.equals(that.name) ? false : (!this.type.equals(that.type) ? false : super.equals(o));
        }
    }
