...
public class FloatArgumentType implements ArgumentType {
    ...
    private static final Collection EXAMPLES = Arrays.asList(new String[] { "0", "1.2", ".5", "-1", "-.5", "-1234.56"});
    ...
    public String toString() {
        return this.minimum == -3.4028235E38F && this.maximum == Float.MAX_VALUE ? "float()" : (this.maximum == Float.MAX_VALUE ? "float(" + this.minimum + ")" : "float(" + this.minimum + ", " + this.maximum + ")");
    }
